...
describe('layout-classes utilities', () => {
  ...
  describe('getDescriptionAlignClass', () => {
    it('should return correct description alignment class', () => {
      ...
      expect(getDescriptionAlignClass('center')).toBe('text-center max-w-3xl mx-auto')
      expect(getDescriptionAlignClass('right')).toBe('text-right max-w-none ml-auto')
    })

    it('should return fallback when invalid alignment provided', () => {
      expect(getDescriptionAlignClass('invalid' as any)).toBe('text-center max-w-3xl mx-auto')
    })
  })
  ...
  describe('getGridColumnClass', () => {
    it('should return correct grid column class', () => {
      ...
      expect(getGridColumnClass(3)).toBe('grid-cols-1 md:grid-cols-2 lg:grid-cols-3')
      expect(getGridColumnClass(4)).toBe('grid-cols-1 md:grid-cols-2 lg:grid-cols-4')
    })

    it('should return fallback when invalid columns provided', () => {
      expect(getGridColumnClass(99 as any)).toBe('grid-cols-1 md:grid-cols-2 lg:grid-cols-3')
    })
  })
  ...
  describe('constants', () => {
    ...
    it('should have all grid column classes defined', () => {
      ...
      expect(GRID_COLUMN_CLASSES[6]).toBe('grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6')
    })
  })
})