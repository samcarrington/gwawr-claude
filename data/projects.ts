...
export const projects: Project[] = [
  {
    ...
    fullDescription:
      'A comprehensive e-commerce platform featuring modern web technologies, scalable architecture, and exceptional user experience. Built with performance and security in mind.',
    category: 'Full-Stack',
    technologies: [
      'Nuxt.js',
      'Node.js',
  ...
  },
  {
    ...
    fullDescription:
      'Modern task management solution designed for teams with real-time collaboration features, intuitive interface, and powerful project organization tools.',
    category: 'Full-Stack',
  ...
  },
  {
    ...
    fullDescription:
      'Personal portfolio website featuring cutting-edge design, smooth animations, and optimized performance. Built with modern web standards and accessibility in mind.',
    category: 'Frontend',
  ...
  },
  {
    ...
    fullDescription:
      'Comprehensive weather application providing detailed forecasts, interactive maps, and beautiful data visualizations for weather enthusiasts and professionals.',
    category: 'Frontend',
  ...
  },
  {
    ...
    fullDescription:
      'Developer-friendly API documentation platform featuring interactive examples, comprehensive guides, and beautiful presentation of technical information.',
  ...
  },
  {
    ...
    fullDescription:
      'Robust backend API system powering mobile applications with advanced user management, real-time synchronization, and scalable architecture.',
    category: 'Backend',
